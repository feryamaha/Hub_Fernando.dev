          ...
          <div className="relative group max-w-2xl mx-auto">
            <input
              ...
              className="w-full px-4 py-3 pr-12 bg-finder-search text-finder-text rounded-lg shadow-sm 
                       border border-finder-border focus:outline-none focus:ring-2 focus:ring-[#4285F4]
                       group-hover:border-[#4285F4] transition-all duration-200"
            />
            <button
              type="submit"
              disabled={isSearching}
              className="absolute right-3 top-1/2 transform -translate-y-1/2 text-finder-text-secondary 
                       hover:text-[#4285F4] focus:outline-none disabled:opacity-50 transition-colors"
            >
              {isSearching ? (
