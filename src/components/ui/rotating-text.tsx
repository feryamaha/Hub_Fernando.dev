...
import { AnimatePresence, type MotionProps, type Transition, motion } from "framer-motion";
...
const RotatingText = forwardRef<RotatingTextRef, RotatingTextProps>((props, ref) => {
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: splitIntoCharacters é uma função pura estável
      ...
      <AnimatePresence mode={animatePresenceMode} initial={animatePresenceInitial}>
        ...
        >
          {elements.map((wordObj, wordIndex, array) => {
            ...
            return (
              <span
                // biome-ignore lint/suspicious/noArrayIndexKey: ordem estável de palavras
                key={wordIndex}
                className={cn("text-rotate-word", splitLevelClassName)}
              >
                {wordObj.characters.map((char, charIndex) => (
                  <motion.span
                    // biome-ignore lint/suspicious/noArrayIndexKey: ordem estável de caracteres
                    key={charIndex}
                    initial={initial}
                    animate={animate}
                    exit={exit}
